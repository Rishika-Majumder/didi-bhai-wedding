    ...
    return (
        <>
            ...
            <div id="main-content" className={`main-content ${isOpen ? '' : 'hidden-lock'}`}>
                ...
                {/* 4. Pre-Wedding Functions Cards Grid */}
                <section id="timeline-pre-wedding" className="timeline-section section-padding">
                    <h2 className="section-title">Pre-Wedding Functions</h2>
                    <div className="section-subtitle-divider"></div>
                    
                    <div className="functions-grid">
                        {/* Card 1: Aiburobhat */}
                        <div className="function-card card-aiburobhat fade-in-up">
                            <div className="function-card-inner">
                                <div className="function-card-caricature">
                                    <img src="/assets/aiburobhat.png" alt="Aiburobhat - Bride" className="function-caricature-img" />
                                </div>
                                <div className="function-card-details">
                                    <span className="function-badge badge-aiburobhat">আইবুড়োভাত</span>
                                    <h3 className="function-title function-title-aiburobhat">Aiburobhat</h3>
                                    <p className="function-tagline">The Traditional Pre-Wedding Feast</p>
                                    <div className="function-info-list">
                                        <div className="info-item">
                                            <span className="info-label">DATE</span>
                                            <span className="info-value">Saturday, 5th December 2026</span>
                                        </div>
                                        <div className="info-item">
                                            <span className="info-label">TIME</span>
                                            <span className="info-value">12:30 PM Onwards</span>
                                        </div>
                                        <div className="info-item">
                                            <span className="info-label">VENUE</span>
                                            <span className="info-value">Firangipani Suites, Kolkata</span>
                                        </div>
                                    </div>
                                    <p className="function-description">
                                        Join us as we celebrate this beloved tradition, blessing our bride-to-be before her new journey begins. An afternoon of blessings, laughter, and a feast of flavors awaits.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Card 2: Sangeet */}
                        <div className="function-card card-sangeet fade-in-up">
                            <div className="function-card-inner">
                                <div className="function-card-caricature">
                                    <img src="/assets/sangeet.png" alt="Sangeet - Couple" className="function-caricature-img" />
                                </div>
                                <div className="function-card-details">
                                    <span className="function-badge badge-sangeet">সঙ্গীত</span>
                                    <h3 className="function-title function-title-sangeet">Sangeet</h3>
                                    <p className="function-tagline">A spirited night of song, dance and laughter</p>
                                    <div className="function-info-list">
                                        <div className="info-item">
                                            <span className="info-label">DATE</span>
                                            <span className="info-value">Saturday, 5th December 2026</span>
                                        ...
                                        <div className="info-item">
                                            <span className="info-label">TIME</span>
                                            <span className="info-value">06:30 PM Onwards</span>
                                        </div>
                                        <div className="info-item">
                                            <span className="info-label">VENUE</span>
                                            <span className="info-value">Firangipani Suites, Kolkata</span>
                                    ...
                                    <p className="function-description">
                                        Join us for a vibrant evening of music, dance, and celebration as family and friends come together to honor the bride. Let the melodies flow, the laughter echo, and the memories last a lifetime.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Card 3: Gaye Holud */}
                        <div className="function-card card-gaye-holud fade-in-up">
                            <div className="function-card-inner">
                                <div className="function-card-caricature">
                                    <img src="/assets/gaye_holud.png" alt="Gaye Holud - Bride" className="function-caricature-img" />
                                </div>
                                <div className="function-card-details">
                                    <span className="function-badge badge-gaye-holud">গায়ে হলুদ</span>
                                    <h3 className="function-title function-title-gaye-holud">Gaye Holud</h3>
                                    <p className="function-tagline">The Auspicious Turmeric Ceremony</p>
                                    <div className="function-info-list">
                                        <div className="info-item">
                                            <span className="info-label">DATE</span>
                                        ...
                                        <div className="info-item">
                                            <span className="info-label">TIME</span>
                                            <span className="info-value">09:00 AM Onwards</span>
                                        </div>
                                        <div className="info-item">
                                            <span className="info-label">VENUE</span>
                                            <span className="info-value">Firangipani Suites, Kolkata</span>
                                    ...
                                    <p className="function-description">
                                        Join us for the auspicious Gaye Holud ceremony, where family and friends come together to bless the bride and groom with love, happiness, and prosperity. A morning filled with tradition, laughter, and golden memories awaits.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                {/* Pre-Wedding Venue Map Card Section */}
                <section id="venue-pre-wedding" className="venue-section section-padding">
                    <h2 className="section-title">Pre-Wedding Venue</h2>
                    <div className="section-subtitle-divider"></div>

                    <div className="venue-wrapper fade-in-up">
                        <div className="venue-info glass-card">
                            <i className="fa-solid fa-hotel venue-icon"></i>
                            <h3>Firangipani Suites</h3>
                            <p className="venue-address">
                                New Town, Kolkata
                            </p>
                            <p className="venue-note">
                                Our beautiful venue for all the pre-wedding celebrations. We look forward to celebrating with you!
                            </p>
                            <a 
                                href="https://maps.google.com/?q=Firangipani+Suites+Kolkata" 
                                target="_blank" 
                        ...
                        <div className="map-container glass-card">
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7367.865536786049!2d88.48618007385015!3d22.581617732642517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a020bab4526955b%3A0x678f46f1b9a2b979!2sFIRANGIPANI%20SUITES%20(A%20Corporate%20Boutique%20Hotel)!5e0!3m2!1sen!2sin!4v1780564472759!5m2!1sen!2sin" 
                                width="100%" 
                                height="450" 
                                style={{ border: 0 }} 
                                allowFullScreen="" 
                                ...
                                title="Pre-Wedding Venue Map Location"
                            ></iframe>
                        </div>
                    </div>
                </section>
